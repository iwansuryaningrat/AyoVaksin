...
<head>
  ...
  <!-- Webpage Title -->
  <title>Kotak Saran | AyoVaksin</title>
      ...
      <div class="saran__section">
        <form action="" method="post" class="row g-3">
          ...
          <div class="col-12 my-2 pe-sm-0 pe-auto">
            <textarea name="pesan" id="pesan" cols="30" rows="5" class="form-control form__control shadow-none" placeholder="Pesan Anda..."></textarea>
          </div>
