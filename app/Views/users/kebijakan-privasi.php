...
<head>
  ...
  <!-- Webpage Title -->
  <title>Kebijakan Privasi | AyoVaksin</title>
...
<body>
  ...
  <div class="av__y">
    <div class="container">
      <div class="kebijakan__section">
        <!-- kebijakan 1 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">1. Cara Kerja AyoVaksin</h5>
        ...
        <!-- kebijakan 2 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">2. Perolehan dan Pengumpulan Data Pribadi</h5>
          <div class="kebijakan__deskripsi">
            <ol type="a">
              <li>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem assumenda, voluptates omnis odio, similique optio sapiente doloribus accusamus temporibus, iusto ex molestiae voluptate molestias nobis. Aliquid voluptas
        ...
        <!-- kebijakan 3 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">3. Penyimpanan Data Pribadi</h5>
          <div class="kebijakan__deskripsi">
            <ol type="a">
              <li>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem assumenda, voluptates omnis odio, similique optio sapiente doloribus accusamus temporibus, iusto ex molestiae voluptate molestias nobis. Aliquid voluptas
        ...
        <!-- kebijakan 4 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">4. Pengelohan dan Penganalisaan Data Pribadi</h5>
          <div class="kebijakan__deskripsi">
            <ol type="a">
              <li>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem assumenda, voluptates omnis odio, similique optio sapiente doloribus accusamus temporibus, iusto ex molestiae voluptate molestias nobis. Aliquid voluptas
          ...
          </div> <!-- end kebijkan deskripsi -->
        </div>
        <!-- end kebijakan 4 -->

        <!-- kebijakan 5 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">5. Penghapusan Data Pribadi</h5>
          <div class="kebijakan__deskripsi">
            <ol type="a">
              <li>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem assumenda, voluptates omnis odio, similique optio sapiente doloribus accusamus temporibus, iusto ex molestiae voluptate molestias nobis. Aliquid voluptas
        ...
        <!-- kebijakan 6 -->
        <div class="mb-md-5 mb-4">
          <h5 class="title__kebijakan">6. Persetujuan</h5>
          <div class="kebijakan__deskripsi">
            <ol type="a">
              <li>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem assumenda, voluptates omnis odio, similique optio sapiente doloribus accusamus temporibus, iusto ex molestiae voluptate molestias nobis. Aliquid voluptas
        ...
        <!-- end kebijakan 6 -->
      </div> <!-- end kebijakan section -->
    </div> <!-- end container -->
  </div>
  <!-- end kebijakan privasi section -->

  <!-- footer -->
  <footer class="foot" style="background: linear-gradient(0deg, rgba(38, 86, 190, 0.9), rgba(38, 86, 190, 0.9)), url(/assets/img/bg-footer.png)">
    <div class="container">
