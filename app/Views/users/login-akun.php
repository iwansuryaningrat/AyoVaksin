...
<head>
  ...
  <!-- Webpage Title -->
  <title>Form Log In | AyoVaksin</title>
...
<body>
    ...
    <div class="row login__section">
      <div class="col-lg-6 col-12 px-0">
        <div class="left__login">
          <div class="mb-4">
            <h2 class="mb-3">Selamat Datang di AyoVaksin</h2>
            <p class="txt__second2">Masuk ke dalam akun yang sudah terdaftar</p>
          </div>
          ...
          <form action="" method="post" class="row g-3 mb-4">
            ...
            <!-- <div id="mssgError" class="form-text mb-2">We'll never share your email with anyone else.</div> -->
            ...
            <div class="col-12 mt-4 d-flex justify-content-center align-items-center">
              <input type="submit" class="btn kp__btn" value="Masuk">
            </div>
          </form>
      ...
      <div class="col-lg-6 col-12 px-0 d-lg-block d-none">
        <div class="right__login bg__img" style="background: linear-gradient(0deg, rgba(38, 86, 190, .9), rgba(38, 86, 190, 0.5)), url(/assets/img/bg-footer.png)">
          <div class="glass__login">
            <h1 class="text-white hyphens__auto">Save yourself to <span class="txt__second">save other</span>.</h1>
          </div>
        </div>
        <a href="/" class="back__tHome">Back to Home</a>
      </div>
  ...
  <!-- home button -->
  <a href="/" class="back__home"><i class="fas fa-home"></i></a>
  <!-- end home button -->
